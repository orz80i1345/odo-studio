...
export interface RawBookingEquipmentItem {
  id: ID
  booking_id: ID
...
export interface RawBookingEquipmentTimeSlot {
  id: ID
  booking_id: ID
  equipment_item_id: ID
  time_slot_id: ID
...
export function toEquipmentItem(raw: RawEquipmentItem): EquipmentItem {
  return {
    id: raw.id,
    name: raw.name,
    description: raw.description,
...
export function toBookingEquipmentItem(raw: RawBookingEquipmentItem): BookingEquipmentItem {
  return {
    id: raw.id,
    bookingId: raw.booking_id,
    equipmentItemId: raw.equipment_item_id,
    name: raw.name,
...
export function toBookingEquipmentTimeSlot(raw: RawBookingEquipmentTimeSlot): BookingEquipmentTimeSlot {
  return {
    id: raw.id,
    bookingId: raw.booking_id,
    equipmentItemId: raw.equipment_item_id,
    timeSlotId: raw.time_slot_id,
    createdAt: raw.created_at ?? '',
  }
}
