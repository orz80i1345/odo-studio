...
export * as discountCodesApi from './endpoints/discountCodes'
export * as equipmentApi from './endpoints/equipment'
export * as systemSettingsApi from './endpoints/systemSettings'
